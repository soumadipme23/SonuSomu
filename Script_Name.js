...
if (!theName){
	theName="";
	myElement.innerHTML = '<h1>Happy Anniversary!</h1>'
}else{
theNewName = theName.replace(/%20/g, ' '); //oooo a regular exp!
//alert(theNewName); 
myElement.innerHTML = '<h1>Happy Anniversary '+theNewName+'!</h1>';	
}
...
function newMessage(){
myElement.innerHTML = '<h2>Four years ago, we set off on a journey of love. Today, I am more certain that our destination is a lifetime of happiness together...</h2>';	
fade_in_button();
}
